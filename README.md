...
- **Tools & Technologies:**  
 🐙 Git, 🐧 Linux, 🐳 Docker, ⚙️ CMake, 🐞 GDB, 📈 Callgrind, 🔍 Valgrind, 📊 Gcov/Lcov, 🗄 SQL, ☁️ AWS, 🗄️ DynamoDB, 🌐 Node.js, 📊 MATLAB, 📈 R, 🖥 Qt, ✅ Catch2, ✨ Clang (format & tidy), 📝 Doxygen, 🐚 Bash, 🛠 Yacc, 🛠 Bison   
...
- [GitLab](https://gitlab.com/miona7)
